...
@ComponentScan(basePackages={"com.pos.app.controller", "com.pos.business.serviceimpl"})
@EnableJpaRepositories(basePackages = {"com.pos.business.dao"})
...
public class SpringFXConfig {
    ...
    LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.pos.domain");
